...
# MAGIC This notebook serves to calculate interest scores for income models.
...
# MAGIC  We transform and standardize those values to produce final interest scores for each income bracket.
# MAGIC
...
df_add_interest_scores = add_interest_scores(
    df_fs_wide_to_long, df_income_interest_coeffs
)
...
df_result = interest_score_final(df_standard_scalar)
