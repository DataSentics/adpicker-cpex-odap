...
def get_schema_sdm_preprocessed():
    ...
    schema = T.StructType( [
            ...
            T.StructField('ZIPPED_DEVICE_DETAILS', T.ArrayType(T.StringType(),True), False),
            T.StructField('OS_ID', T.LongType(),False),
            T.StructField('OS_LANGUAGE', T.StringType(),True),
            T.StructField('DATE', T.DateType(),True),
            T.StructField('TIMESTAMP', T.TimestampType(),True),
            T.StructField('PAGES_TIMES', T.ArrayType(T.ArrayType(T.StringType(),True), False), False),
...
def get_schema_sdm_url():
    schema = T.StructType(
        [
            ...
            T.StructField('URL_TITLE_CLEANED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_TITLE_STEMMED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_KEYWORDS_CLEANED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_KEYWORDS_STEMMED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_DESCRIPTIONS_CLEANED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_DESCRIPTIONS_STEMMED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_NORMALIZED_KEYWORDS_CLEANED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_NORMALIZED_KEYWORDS_STEMMED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_TOKENS_ALL_CLEANED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_TOKENS_ALL_STEMMED', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_TOKENS_ALL_CLEANED_UNIQUE', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_TOKENS_ALL_STEMMED_UNIQUE', T.ArrayType(T.StringType(),True),False),
            T.StructField('URL_TITLE_CLEANED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_TITLE_STEMMED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_KEYWORDS_CLEANED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_KEYWORDS_STEMMED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_DESCRIPTIONS_CLEANED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_DESCRIPTIONS_STEMMED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_NORMALIZED_KEYWORDS_CLEANED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_NORMALIZED_KEYWORDS_STEMMED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_TOKENS_ALL_CLEANED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_TOKENS_ALL_STEMMED_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_TOKENS_ALL_CLEANED_UNIQUE_BIGRAMS', T.ArrayType(T.StringType(),True),True),
            T.StructField('URL_TOKENS_ALL_STEMMED_UNIQUE_BIGRAMS', T.ArrayType(T.StringType(),True),True),
